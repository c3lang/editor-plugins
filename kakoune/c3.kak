...
evaluate-commands %sh{
	keywords='alias assert asm attrdef bitstruct break case catch constdef const continue default defer do else enum extern false faultdef for foreach foreach_r fn tlocal if inline import lengthof macro module nextcase null interface return static struct switch true try typedef union var while'
	...
	types='void bool char double float float16 bfloat int128 ichar int iptr isz long short sz uint128 uint ulong uptr ushort usz float128 any fault typeid'
